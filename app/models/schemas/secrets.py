...
from app.models.common import IdMixin, TtlMixin
...
class SecretBase(BaseModel):
    ...
    max_accesses: Optional[int] = Field(None, title=MAX_ACCESSES_TITLE, ge=1)
...
class SecretOut(SecretBase, IdMixin, TtlMixin):
    max_accesses: Optional[int] = Field(
        None, title=MAX_ACCESSES_TITLE, ge=0  # Can be zero
    )
